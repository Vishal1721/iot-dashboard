    ...
    <div className="lg:px-16">
      <Card className="h-auto bg-white rounded-xl md:rounded-2xl shadow-lg mb-6 border border-gray-200">
        <CardHeader className="flex items-center justify-center text-center p-4 bg-gradient-to-r from-blue-600 to-blue-800 rounded-t-xl">
          <CardTitle className="text-2xl font-bold text-white">Historical Bar Chart</CardTitle>
            ...
            <div className="w-full overflow-auto">
              <div className="w-full flex flex-wrap justify-center gap-6">
                {sensorData?.map((data, index) => {
                  ...
                  return (
                    <Card key={index} className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow w-full max-w-[550px] lg:w-5/12 xl:max-w-3/5 mb-6 border border-gray-200">
